<script>
  import Avatars from "$lib/components/avatars/avatar.svelte";
...
<Avatars
  avatarContent="image"
  avatarContentSource="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnDZcO8iYBNpfQdlviO9b3KNs8FhXsGG22Fg&s"
